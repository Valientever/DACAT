...
runs=(
    ...
    "clean_1210 ext_predicts clean clean"
    ...
    "mblur_1210 ext_predicts motion_blur motion_blur"
    "dblur_1210 ext_predicts defocus_blur defocus_blur"
    "ueillumination_1210 ext_predicts uneven_illumination uneven_illumination"
    "seffect_1210 ext_predicts smoke_effect smoke_effect"
    "random_1210 ext_predicts random random"
...
agg="$ROOT/ext_all_per_video_metrics.csv"
